          ...
          <div class="home-banner-container">
            <div class="home-banner">
                ...
                <div class="process-bar">
                  ...
                  <div class="process-body">
                    <div class="process-content">
                      <img src={ColorBarIcon} alt="" />
                    </div>
                  </div>
                </div>
                <p>
                  Staking 1 sol generates 10 $SNUCK per day. If you stake 3
                  sols, each sol will pump you x1.25 more $SNUCK!
                </p>
                <div class="home-banner-staking">
                  <button class="start-staking-btn" tabIndex="0" type="button">
                    Start staking
                  </button>
                  <img
                    src="./Shredded sol NFT Staking_files/meat.50886310.svg"
                    alt=""
                  />
                </div>
              </div>
              <div class="home-banner-image">
                <img
                  src="./Shredded sol NFT Staking_files/whey-token.1fa523f6.png"
                  alt=""
                />
              </div>
            </div>
